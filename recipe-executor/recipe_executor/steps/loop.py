...
class LoopStep(BaseStep[LoopStepConfig]):
    ...
    async def execute(self, context: ContextProtocol) -> None:
        ...
        # Resolve items (by template or direct)
        ...
        # Flatten items into (key, value) list
        if isinstance(items_obj, list):
            items_list: List[Tuple[Any, Any]] = list(enumerate(items_obj))
        else:
        ...
        # Concurrency control: 0 => unlimited, >0 => semaphore, 1 => sequential
        ...
        # Store final results and errors
