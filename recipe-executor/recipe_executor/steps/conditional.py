...
def evaluate_condition(
    ...
    # Replace function-like logical calls to avoid Python keyword conflicts
...
class ConditionalStep(BaseStep[ConditionalConfig]):  # type: ignore
    """
    ...
    async def execute(self, context: ContextProtocol) -> None:
        ...
        if isinstance(branch, dict) and branch.get("steps"):
            ...
            self.logger.debug("No branch to execute for condition result %s", result)
    ...
    async def _execute_branch(
        ...
        for step_def in steps:
            ...
            if not step_type:
                self.logger.debug("Step definition missing 'type', skipping: %s", step_def)
                continue
