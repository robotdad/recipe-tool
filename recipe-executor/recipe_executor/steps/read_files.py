...
"""
ReadFilesStep: Read one or more files from disk and store their content in the execution context.
Supports templated paths, optional files, JSON/YAML parsing, and merge modes.
"""
...
class ReadFilesStep(BaseStep[ReadFilesConfig]):
    ...
    async def execute(self, context: ContextProtocol) -> None:
        ...
        if isinstance(raw_path, str):
            # Render templates and split comma-separated values
