...
recipe-tool --execute recipes/document_generator/document-generator-recipe.json \
    outline_file=recipes/recipe_executor/docs/recipe-json-authoring-guide-outline.json \
    output_root=output/docs \
    model=openai/o4-mini
```

This command will create a structured outline of the documentation, including sections for each component, their specifications, and any relevant resources. The generated documentation will be saved in the specified output directory.
...
=== File: recipes/recipe_executor/docs/recipe-json-authoring-guide-outline.json ===
{
